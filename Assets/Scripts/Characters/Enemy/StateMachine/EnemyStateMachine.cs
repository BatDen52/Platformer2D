...
{
    public EnemyStateMachine(Fliper fliper, Mover mover, EnemyVision vision, Animator animator, EnemyAttacker attacker, EnemySound audio, WayPoint[] wayPoints,
                            float maxSqrDistance, Transform transform, float waitTime, float tryFindTime)
    {
        States = new Dictionary<Type, State>()
        {
            ...
            { typeof(FollowState), new FollowState(this, animator, fliper, mover, vision, audio, tryFindTime, attacker.SqrAttackDistance) },
